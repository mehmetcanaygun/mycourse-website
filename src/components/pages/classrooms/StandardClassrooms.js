...
const StandardClassrooms = () => {
  return (
    <div className="standard-classroom-page">
      <Header
        title={"Standard Classrooms"}
        imgPath={
          "url(./img/classroom-header-bg.jpg) no-repeat center center/cover"
        }
      />
      ...
      <div className="page-wrapper">
        <div className="page-image">
          <img src="./img/classroom-header-bg.jpg" alt="page-img" />
        </div>
        <hr />
...
export default StandardClassrooms;
